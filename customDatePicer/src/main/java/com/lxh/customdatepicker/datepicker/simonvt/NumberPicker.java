...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int UNSCALED_DEFAULT_SELECTION_DIVIDERS_DISTANCE = 30;
    ...
    /**
     * The default input text editability.
     */
    private static final boolean DEFAULT_INPUT_TEXT_EDITABLE = true;
    ...
    /**
     * If could edit input text content.
     */
    private final boolean mInputTextEditable;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mInputTextEditable = attributesArray.getBoolean(R.styleable.NumberPicker_inputTextEditable, DEFAULT_INPUT_TEXT_EDITABLE);
        ...
        mInputText.setEnabled(mInputTextEditable);
        if (mInputTextEditable) {
    ...
    public void setEnabled(boolean enabled) {
        ...
        mInputText.setEnabled(mInputTextEditable && enabled);
    }
